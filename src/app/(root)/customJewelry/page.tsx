...
const customJewelryOrder = [
  {
    ...
    desc: `تلاش کردیم گالری‌های ساویس سرشار از آرامش و حس خوب برای شما باشند.`,
      ...
      <section className="mx-auto mt-10 w-[91.12%] lg:mt-[60px] lg:w-[91.67%] 4xl:w-[85%]">
        <div className="mx-auto mb-10 flex flex-col items-center gap-[18px] lg:mb-[60px] lg:w-[760px] lg:gap-y-6">
          ...
          <p className="text-center font-peyda-400 lg:text-xl">
            ساویس، به عنوان نخبه در طراحی منحصر به فرد، با ترکیب خلاقیت و هنر،
        ...
        <div className="my-10 grid grid-cols-1 gap-6 lg:my-[60px] lg:grid-cols-2">
          <div className="flex flex-col justify-center gap-y-6">
            ...
            <p className="font-peyda-400 text-lg text-blue-1050">
              دیزاینر ها و ایده پردازان ساویس،برای هر چه زیباتر کردن محصول شما،
        ...
        <div className="my-10 grid grid-cols-1 gap-6 lg:my-[60px] lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-y-6">
            ...
            <p className="font-peyda-400 text-lg text-blue-1050">
              طلا و جواهر سازان ساویس، با توجه به طرح شما بهترین متریال را که
